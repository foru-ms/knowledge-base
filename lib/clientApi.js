...
export const clientApi = {
    ...
    // Articles (formerly threads)
    articles: {
        async create(title, body, userId) {
            return clientFetch('/api/createArticle', {
                method: 'POST',
    ...
    // Comments (formerly posts)
    comments: {
        async create(body, articleId, userId) {
            return clientFetch('/api/createComment', {
                method: 'POST',
    ...
    // Threads (deprecated, kept for compatibility)
    threads: {
        async create(title, body, userId) {
    ...
    // Posts (deprecated, kept for compatibility)
    posts: {
