                    ...
                    <div className="md:flex items-center">
                        <div className="md:mt-0 mt-4 flex items-center text-gray-600">
                            <p className="text-gray-600 text-xs">
                                by <span className="text-blue-500">{threadData?.user?.username}</span>
                            </p>
                            <div className="w-1 h-1 bg-gray-500 rounded-full mx-2" />
                            <p className="text-gray-600 text-xs">{threadData?.createdAt}</p>
                        </div>
                    </div>
                    <p className="mt-4 text-gray-600 text-sm">{threadData?.body}</p>
